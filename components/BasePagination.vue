...
<template>
  <div class="nui-pagination  mt-2 !flex !justify-end" :class="[
    ...
    <BaseFocusLoop class="nui-pagination-buttons !bg-transparent !border-0" :class="[rounded && radiuses[rounded], props.classes?.buttons]">
      ...
      <!-- Previous -->
      <NuxtLink :to="paginatedLink(currentPage - 1)" tabindex="0" class="nui-pagination-button !rounded-full !bg-[#303030] !w-10"
        ...
        <slot name="previous-icon">
          <Icon :name="nextIcon" class="pagination-button-icon !text-muted-200" />
        </slot>
      </NuxtLink>
      ...
      <!-- Link -->
      <li>
        <NuxtLink :to="paginatedLink(1)" tabindex="0" class="nui-pagination-link !bg-[#303030] !rounded-full !border-0" :class="[
      ...
      <li v-for="page in pages" :key="page">
        <NuxtLink :to="paginatedLink(page)" tabindex="0" :aria-current="currentPage === page ? 'page' : undefined"
          class="nui-pagination-link !bg-[#303030] !rounded-full !border-0" :class="[
      ...
      <li v-if="showLastLink">
        <NuxtLink :to="paginatedLink(lastPage)" tabindex="0" class="nui-pagination-link !bg-[#303030] !rounded-full !border-0" :class="[
      ...
      <!-- Next -->
      <NuxtLink :to="paginatedLink(currentPage + 1)" tabindex="0" class="nui-pagination-button !w-10 !rounded-full !bg-[#303030]"
        :class="props.classes?.button" @keydown.space="(e: any) => (e.target as HTMLAnchorElement).click()"
        @click="(e: any) => handleLinkClick(e, currentPage + 1)">
        <slot name="next-icon">
          <Icon :name="previousIcon" class="pagination-button-icon !text-muted-200" />
        </slot>
      </NuxtLink>
