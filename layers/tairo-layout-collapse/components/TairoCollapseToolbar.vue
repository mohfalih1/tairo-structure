...
<template>
  <div
    class="relative my-3 flex h-14 items-center gap-2 px-4 border-primary-300 bg-[#101010] rounded-2xl"
    :class="props.horizontalScroll && 'pe-4 xl:pe-10'">
    <TairoCollapseBurger v-if="showNavBurger" class="-ms-3" />

    <BaseHeading v-if="app.tairo?.collapse?.toolbar?.showTitle" as="h1" size="2xl" weight="light"
